...

{
  ...
  perSystem = { inputs', self', lib, system, ... }: {
    packages.push_notifications_service_provider_test_dna =
      inputs.tnesh-stack.outputs.builders.${system}.dna {
        ...
        zomes = {
          ...
          push_notifications_service_provider_integrity =
            self'.packages.push_notifications_service_provider_integrity;
          push_notifications_service_provider =
            self'.packages.push_notifications_service_provider;
        };
      };
  };
}
