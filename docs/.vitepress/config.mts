...
export default withMermaid({
	...
	base: '/push-notifications-service-provider-zome',
	title: 'Push Notifications Service Provider Zome',
	description: 'Push Notifications Service Provider zome for holochain apps',
	themeConfig: {
			...
			},
			{
				...
				items: [
					...
					},
					{
						...
						items: [
							{
								text: 'PushNotificationsServiceProviderStore',
		...
		socialLinks: [
			{
				icon: 'github',
				link: 'https://github.com/darksoil-studio/push-notifications-service-provider-zome',
			},
		],
		search: {
			provider: 'local',
